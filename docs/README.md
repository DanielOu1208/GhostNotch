...
Start here if you want to understand, build, test, or contribute to GhostNotch.
...
The files in [archive](archive/) are preserved for context. They include the completed MVP implementation plan, dated renderer acceptance notes, and Ghostty VT architecture review work. Treat them as history, not as the current public roadmap.
